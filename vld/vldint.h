...
private:
    ...
    SIZE_T reportLeaks(heapinfo_t* heapinfo, bool& firstLeak, Set<std::pair<DWORD, SIZE_T>>& rankLists, Set<blockinfo_t*>& aggregatedLeaks, DWORD threadId = (DWORD)-1);
    ...
    UINT32               m_reportFilterLessBytes;
    UINT32               m_reportMaxLeakSizeRankingsCount;
...
#define VLD_DEFAULT_REPORT_FILTER_LESS_BYTES 10
#define VLD_DEFAULT_REPORT_MAX_LEAK_SIZE_RANKINGS_COUNT 10
